...
import image1 from "../images/quality_1212289.png"
        ...
        <footer>
            <div className={styles.footer}>
                <div className={styles.footerSection1}>
                    ...
                    <img src={image1} height="50px" width="30px" alt="Quality Logo" />
                </div>
                ...
                <div className={styles.paymentcontainer}>
                    <div>
                        ...
                        <div className={styles.container}>
                            ...
                            <p><img src={image2} height="40px" width="55px" alt="Payment Methods" /></p>
